...
class ChromeSearch(unittest.TestCase):
    ...
    #Check that the main Apple logotype is visible and clickable
    ...
    #Check that the top menu is visible and clickable
    ...
    #Check that in the home page Carusel is work correct
    ...
    #Check that the footer menu in home page is visible and clickable
